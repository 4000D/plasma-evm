...
var (
	...
	invalidExitReceiptsLookupPrefix = []byte("rl") // invalidExitReceiptsLookupPrefix + num (uint64 big endian)+ num (uint64 big endian)
	// -> invalid exit receipt lookup metadata
