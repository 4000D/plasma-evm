...
func TestGetDefaultStaminaFromStorageKey(t *testing.T) {
	...
	if common.BytesToHash(params.DefaultStamina.Bytes()) != common.BytesToHash(stamina.Bytes()) {
		t.Fatalf("unexpected value: want %x, got %x", params.DefaultStamina, stamina)
	}
}
