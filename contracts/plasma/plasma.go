...
func DeployPlasmaContracts(
	opt *bind.TransactOpts, backend *ethclient.Client, plsConfig *pls.Config, staminaConfig *params.StaminaConfig,
	tonAddress common.Address,
	withPETH bool, development bool, NRELength *big.Int) (common.Address, *core.Genesis, error) {
